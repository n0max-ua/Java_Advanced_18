...
<body>
	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header" style="margin-right: 20px; margin-top: 15px">Spring MVC</div>
	...
	<div class="container">
		...
		<c:choose>
			<c:when test="${mode == 'PARTIPIANT_VIEW'}">
			...
			<c:when
				test="${mode == 'PARTIPIANT_EDIT' || mode == 'PARTIPIANT_CREATE'}">
